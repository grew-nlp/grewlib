...
module G_graph: sig
  ...
  *)
  val concat_feats_opt: t -> Ast.side ->  Gid.t -> Gid.t -> string -> Regexp.t -> (t * (string * Feature_value.t) list) option
...
module Delta : sig
  ...
  val set_meta: G_graph.t -> string -> string option -> t -> t
